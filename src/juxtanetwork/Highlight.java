...
public class Highlight {
    ...
    public void highlightremove(JTextComponent textComp) {
     ...
     public void highlight(JTextComponent textComp, int start, int end,Color color) {
        try {
         ...
         public void highlightText1(JTextComponent textComp, String pattern) {
        if (pattern.length() == 0) {
        ...
        try {
            ...
            while ((pos = text.toUpperCase().indexOf(pattern.toUpperCase(), pos)) >= 0) {
                ...
                if (currSearchPos > savedHilitePos1) {
                    if (stopSearchSelect == false) {
                        ...
                        hilite.addHighlight(pos, pos + pattern.length(), myHighlightPainterFound);
            ...
            if (currSearchPos < savedHilitePos1) {
                savedHilitePos1 = 0;
                  ...
                  public void highlightText2(JTextComponent textComp, String pattern) {
        if (pattern.length() == 0) {
            highlightremove(textComp);
            return;
        }
    ...
    public void backhighlightText1(JTextComponent textComp, String pattern) {
        if (pattern.length() == 0) {
            highlightremove(textComp);
            return;
        }
    ...
    public void backhighlightText2(JTextComponent textComp, String pattern) {
        if (pattern.length() == 0) {
            highlightremove(textComp);
            return;
        }
